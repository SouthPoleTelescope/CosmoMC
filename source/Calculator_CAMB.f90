    ...
    real(mcp) lens_recon_scale, rms, pmf_scale, tens_pmf_scale
    ...
    subroutine LoadFiducialHighLTemplate(this)
      class(CAMB_Calculator) :: this
      !This should be a lensed scalar CMB power spectrum, 
      !e.g. for including at very high L where foregrounds etc. dominate anyway
      integer L,  status
      real(mcp) array(4)
      Type(TTextFile) :: F
